...
# setup openssh
$ssh_download_url = "http://www.mls-software.com/files/setupssh-6.6p1-1-v1.exe"
if ($is_64bit) {
    Write-Host "64 bit OS found"
    $ssh_download_url = "http://www.mls-software.com/files/setupssh-6.6p1-1-v1%28x64%29.exe"
}
